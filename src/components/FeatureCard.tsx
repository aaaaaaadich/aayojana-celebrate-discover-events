    ...
    <ScrollReveal direction="scale" className="h-full">
      <Card className="bg-card transition-all duration-500 animate-hover-lift h-full animate-3d-hover group overflow-hidden animate-morph scroll-hover-lift glassmorphism hover:glassmorphism-strong">
        ...
        <CardContent className="p-6 flex flex-col items-center text-center relative z-10">
          <div className="h-14 w-14 rounded-full bg-saffron-100 dark:bg-saffron-900/30 flex items-center justify-center mb-4 transition-all duration-500 group-hover:scale-110 animate-3d-hover animate-magnetic animate-pulse-glow">
            {/* Icon Glow Effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-saffron-500/30 to-blue-500/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-md animate-pulse-ring"></div>
            
            <Icon 
              size={28} 
              color={iconColor} 
              className="transition-all duration-500 group-hover:rotate-12 relative z-10 icon-hover" 
            />
          </div>
          
          <h3 className="text-xl font-bold mb-2 transition-all duration-500 group-hover:text-saffron-500 animate-gradient-flow bg-clip-text text-transparent">
            {title}
          </h3>
          ...
          {/* Bottom Decoration */}
          <div className="mt-4 w-8 h-0.5 bg-gradient-to-r from-blue-500 to-saffron-500 opacity-0 group-hover:opacity-100 transition-all duration-500 animate-pulse-glow"></div>
        </CardContent>
      </Card>
    </ScrollReveal>
  );
