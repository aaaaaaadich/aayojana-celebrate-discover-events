    ...
    <section className="relative min-h-screen flex items-center bg-gradient-to-b from-blue-50 to-white dark:from-nepali-800 dark:to-nepali-900 py-24 md:py-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-14 md:gap-20 items-center">
          {/* Left: Content */}
          <div className="text-center md:text-left max-w-xl md:max-w-xl mx-auto md:mx-0">
            ...
            {/* Buttons */}
            <div className="flex flex-col sm:flex-row gap-5 justify-center md:justify-start mb-9">
              <Button
                asChild
          ...
          <div className="flex justify-center md:justify-end relative mt-14 md:mt-0">
